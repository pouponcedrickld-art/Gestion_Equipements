...
const submitTraitement = async () => {
  ...
  try {
    await demandeMaterielApi.traiter(processingDemande.value.id, traitement.value)
...
const submitEdit = async () => {
  ...
  try {
    await demandeMaterielApi.update(editingDemande.value.id, editForm.value)
...
const executeDelete = async () => {
  ...
  try {
    await demandeMaterielApi.destroy(deletingDemande.value.id)
