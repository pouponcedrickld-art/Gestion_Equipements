<template>
<<<<<<< HEAD:frontend/src/views/affectations/AffectationsView.vue
  <MainLayout>
<<<<<<< HEAD
=======
  <AgenceLayout>
>>>>>>> 2c965af4f2361eccbef055db409105b763f2340d:frontend/src/views/agence/affectations/AffectationsView.vue
