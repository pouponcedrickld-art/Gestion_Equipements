...
export const getMenuItems = () => {
    ...
    const items = [
        ...
        { label: 'Agents', icon: 'pi pi-users', route: '/agents', visible: !['agent', 'technicien_maintenance'].includes(role) },
        { label: 'Catégories', icon: 'pi pi-tags', route: '/categories', visible: ['super_admin', 'gestionnaire_stock_general'].includes(role) },
        ...
        { label: 'Retours Agence', icon: 'pi pi-undo', route: '/retours', visible: ['chef_agence', 'gestionnaire_stock'].includes(role) },
        { label: 'Retours Siège', icon: 'pi pi-undo', route: '/direction/retours', visible: ['super_admin', 'gestionnaire_stock_general'].includes(role) },
        ...
        { label: 'Affectations', icon: 'pi pi-arrow-right-arrow-left', route: '/affectations', visible: ['super_admin', 'gestionnaire_stock_general', 'chef_agence', 'gestionnaire_stock'].includes(role) },
